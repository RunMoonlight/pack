    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (headerValues != null && headerValues.size() > 0) {
            ...
            if ("gank".equals(headerValue)) {
                newBaseUrl = HttpUrl.parse(ApiConfig.BASE_URL_GANK);
            }else if ("pack".equals(headerValue)) {
                newBaseUrl = HttpUrl.parse(ApiConfig.BASE_URL_PACK);
            }else{
